# -*- coding: utf-8 -*-
"""pushfiles 作业 - th11 完整处理 (th09 同构: msg 是转换, 无二拆)
"""
import pathlib, shutil, subprocess, sys, json
sys.stdout.reconfigure(encoding='utf-8')

ROOT = pathlib.Path(r'E:\GitWorkspace\thworks')
SRC_DIR = ROOT / 'tsa' / 'th11'
OUT_ROOT = ROOT / 'pushfiles' / 'th11'
...
REL_BASE = ROOT / 'release' / 'tsa' / 'th11'
...
def main():
    ...
    print('=== th11 拆包 ===')
    out_main = OUT_ROOT / 'th11.dat'
    extract('th11.dat', out_main, 11)
