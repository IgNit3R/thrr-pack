# -*- coding: utf-8 -*-
"""pushfiles 作业 - th17 完整处理 (th09 同构: msg 是转换, 无二拆)
"""
import pathlib, shutil, subprocess, sys, json
sys.stdout.reconfigure(encoding='utf-8')

ROOT = pathlib.Path(r'E:\GitWorkspace\thworks')
SRC_DIR = ROOT / 'tsa' / 'th17'
OUT_ROOT = ROOT / 'pushfiles' / 'th17'
...
REL_BASE = ROOT / 'release' / 'tsa' / 'th17'
...
def main():
    ...
    print('=== th17 拆包 ===')
    out_main = OUT_ROOT / 'th17.dat'
    extract('th17.dat', out_main, 17)
