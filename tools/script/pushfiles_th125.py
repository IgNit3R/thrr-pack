# -*- coding: utf-8 -*-
"""pushfiles 作业 - th125 完整处理 (th09 同构: msg 是转换, 无二拆)
"""
import pathlib, shutil, subprocess, sys, json
sys.stdout.reconfigure(encoding='utf-8')

ROOT = pathlib.Path(r'E:\GitWorkspace\thworks')
SRC_DIR = ROOT / 'tsa' / 'th125'
OUT_ROOT = ROOT / 'pushfiles' / 'th125'
...
REL_BASE = ROOT / 'release' / 'tsa' / 'th125'
...
def main():
    ...
    print('=== th125 拆包 ===')
    out_main = OUT_ROOT / 'th125.dat'
    extract('th125.dat', out_main, 125)
