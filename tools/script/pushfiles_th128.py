# -*- coding: utf-8 -*-
"""pushfiles 作业 - th128 完整处理 (th09 同构: msg 是转换, 无二拆)
"""
import pathlib, shutil, subprocess, sys, json
sys.stdout.reconfigure(encoding='utf-8')

ROOT = pathlib.Path(r'E:\GitWorkspace\thworks')
SRC_DIR = ROOT / 'tsa' / 'th128'
OUT_ROOT = ROOT / 'pushfiles' / 'th128'
...
REL_BASE = ROOT / 'release' / 'tsa' / 'th128'
...
def main():
    ...
    print('=== th128 拆包 ===')
    out_main = OUT_ROOT / 'th128.dat'
    extract('th128.dat', out_main, 128)
