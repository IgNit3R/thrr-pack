# -*- coding: utf-8 -*-
"""pushfiles 作业 - th14 完整处理 (th09 同构: msg 是转换, 无二拆)
"""
import pathlib, shutil, subprocess, sys, json
sys.stdout.reconfigure(encoding='utf-8')

ROOT = pathlib.Path(r'E:\GitWorkspace\thworks')
SRC_DIR = ROOT / 'tsa' / 'th14'
OUT_ROOT = ROOT / 'pushfiles' / 'th14'
...
REL_BASE = ROOT / 'release' / 'tsa' / 'th14'
...
def main():
    ...
    print('=== th14 拆包 ===')
    out_main = OUT_ROOT / 'th14.dat'
    extract('th14.dat', out_main, 14)
