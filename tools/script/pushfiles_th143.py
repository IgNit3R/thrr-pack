# -*- coding: utf-8 -*-
"""pushfiles 作业 - th143 完整处理 (th09 同构: msg 是转换, 无二拆)
"""
import pathlib, shutil, subprocess, sys, json
sys.stdout.reconfigure(encoding='utf-8')

ROOT = pathlib.Path(r'E:\GitWorkspace\thworks')
SRC_DIR = ROOT / 'tsa' / 'th143'
OUT_ROOT = ROOT / 'pushfiles' / 'th143'
...
REL_BASE = ROOT / 'release' / 'tsa' / 'th143'
...
def main():
    ...
    print('=== th143 拆包 ===')
    out_main = OUT_ROOT / 'th143.dat'
    extract('th143.dat', out_main, 143)
