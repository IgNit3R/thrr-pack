# -*- coding: utf-8 -*-
"""pushfiles 作业 - th13 完整处理 (th09 同构: msg 是转换, 无二拆)
"""
import pathlib, shutil, subprocess, sys, json
sys.stdout.reconfigure(encoding='utf-8')

ROOT = pathlib.Path(r'E:\GitWorkspace\thworks')
SRC_DIR = ROOT / 'tsa' / 'th13'
OUT_ROOT = ROOT / 'pushfiles' / 'th13'
...
REL_BASE = ROOT / 'release' / 'tsa' / 'th13'
...
def main():
    ...
    print('=== th13 拆包 ===')
    out_main = OUT_ROOT / 'th13.dat'
    extract('th13.dat', out_main, 13)
