# -*- coding: utf-8 -*-
"""pushfiles 作业 - th12 完整处理 (th09 同构: msg 是转换, 无二拆)
"""
import pathlib, shutil, subprocess, sys, json
sys.stdout.reconfigure(encoding='utf-8')

ROOT = pathlib.Path(r'E:\GitWorkspace\thworks')
SRC_DIR = ROOT / 'tsa' / 'th12'
OUT_ROOT = ROOT / 'pushfiles' / 'th12'
...
REL_BASE = ROOT / 'release' / 'tsa' / 'th12'
...
def main():
    ...
    print('=== th12 拆包 ===')
    out_main = OUT_ROOT / 'th12.dat'
    extract('th12.dat', out_main, 12)
