# -*- coding: utf-8 -*-
"""pushfiles 作业 - th165 完整处理 (th09 同构: msg 是转换, 无二拆)
"""
import pathlib, shutil, subprocess, sys, json
sys.stdout.reconfigure(encoding='utf-8')

ROOT = pathlib.Path(r'E:\GitWorkspace\thworks')
SRC_DIR = ROOT / 'tsa' / 'th165'
OUT_ROOT = ROOT / 'pushfiles' / 'th165'
...
REL_BASE = ROOT / 'release' / 'tsa' / 'th165'
...
def main():
    ...
    print('=== th165 拆包 ===')
    out_main = OUT_ROOT / 'th165.dat'
    extract('th165.dat', out_main, 165)
