# -*- coding: utf-8 -*-
"""pushfiles 作业 - th15 完整处理 (th09 同构: msg 是转换, 无二拆)
"""
import pathlib, shutil, subprocess, sys, json
sys.stdout.reconfigure(encoding='utf-8')

ROOT = pathlib.Path(r'E:\GitWorkspace\thworks')
SRC_DIR = ROOT / 'tsa' / 'th15'
OUT_ROOT = ROOT / 'pushfiles' / 'th15'
...
REL_BASE = ROOT / 'release' / 'tsa' / 'th15'
...
def main():
    ...
    print('=== th15 拆包 ===')
    out_main = OUT_ROOT / 'th15.dat'
    extract('th15.dat', out_main, 15)
